...
import com.business.gym_app.data.api.LocalChatMessage
...
class ChatRepository(
    ...
    suspend fun sendMessage(token: String, receiverId: String, message: String): Boolean {
        return try {
            ...
            val response = apiService.sendChatMessage(encodedPeer, com.business.gym_app.data.api.MessageRequest(message))
