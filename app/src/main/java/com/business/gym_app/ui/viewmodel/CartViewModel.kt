...
import com.business.gym_app.data.api.CartItemRequest
...
import com.business.gym_app.data.local.entity.CartItemEntity
        ...
        try {
            ...
            if (userId != null) {
                ...
                orders.forEach { order ->
                    try {
                        orderDao.insertOrder(com.business.gym_app.data.local.entity.OrderEntity(
